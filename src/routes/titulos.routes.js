...
//Atualizar um título
router.patch("/", controller.atualizarEstudio);

router.patch("/", controller.atualizarTitulos);
//Deletar um título

router.delete("/", controller.deleteEstudio);

router.delete("/", controller.deleteTitulo);
